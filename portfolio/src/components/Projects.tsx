import Travel from '../assets/uplaods/Travel.jpg';
import Clothes from '../assets/uplaods/clothes.jpg'
import Cos from '../assets/uplaods/comsmotice.jpg'
import Shoes from '../assets/uplaods/shoes.jpg'
import Student from '../assets/uplaods/student.png'
        ...
        <div className="continier-project">
            <div className="display-card">
                <div className='display-img-one'>
                    <img src={Travel} alt="Travel destination" />
                ...
                <div className='display-img-two'>
                    <img src={Travel} alt="Featured adventure" />
            ...
            <div className="display-card-two">
                <div className="pro-items i1">
                    <img src={Clothes} alt="Tropical getaway" />
                ...
                <div className="pro-items i2">
                    <img src={Cos} alt="Mountain adventure" />
                    <div className="dips-desc">
                ...
                <div className="pro-items i3">
                    <img src={Travel} alt="Cultural experience" />
                    <div className="dips-desc">
                ...
                <div className="pro-items i4">
                    <img src={Shoes} alt="City exploration" />
                    <div className="dips-desc">
                        <h4>Shoes shope</h4>
                ...
                <div className="pro-items i5">
                    <img src={Student} alt="Romantic getaway" />
                    <div className="dips-desc">
                        <h4>SChool App</h4>
